...
def parse_args():
    ...
    parser.add_argument("--train_csv", type=str, help="Path to .csv file with rows for all train")
    parser.add_argument("--val_csv", type=str, help="Path to .csv file with rows for all val")
    parser.add_argument("--data_root_dir", type=str, help="Path to directory for images")
...
def main():
    ...
    # Use custom dataset
    train_dataset = ImageSegmentationDataset(train_image_paths, train_mask_paths, transform=train_transform, data_root_dir=data_root_dir)
    val_dataset = ImageSegmentationDataset(val_image_paths, val_mask_paths, transform=val_transform, data_root_dir=data_root_dir)
    ...
    for epoch in range(num_epochs):
        ...
        if mean_iou > best_mean_iou:
            ...
            model_filename = os.path.join(model_directory, f'model_best.pt')
